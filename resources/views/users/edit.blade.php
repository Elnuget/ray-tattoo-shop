                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('users.update', $user) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            @if($user->foto)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $user->foto) }}" alt="Foto actual" class="w-20 h-20 rounded-full object-cover border border-red-500/30">
                                    <p class="text-gray-400 text-sm mt-1">Foto actual</p>
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" name="descripcion" rows="4" 
                                      ...
                                      placeholder="Cuéntanos sobre ti, tus especialidades, experiencia...">{{ old('descripcion', $user->descripcion) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="redes_instagram" class="block mt-1 w-full bg-black/30 border-red-500/30 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500" 
                                                  type="text" name="redes[instagram]" :value="old('redes.instagram', $user->redes['instagram'] ?? '')" placeholder="@tu_usuario" />
                                </div>
                                <div>
                                    ...
                                    <x-text-input id="redes_facebook" class="block mt-1 w-full bg-black/30 border-red-500/30 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500" 
                                                  type="text" name="redes[facebook]" :value="old('redes.facebook', $user->redes['facebook'] ?? '')" placeholder="facebook.com/tu_perfil" />
                                </div>
                                <div>
                                    ...
                                    <x-text-input id="redes_twitter" class="block mt-1 w-full bg-black/30 border-red-500/30 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500" 
                                                  type="text" name="redes[twitter]" :value="old('redes.twitter', $user->redes['twitter'] ?? '')" placeholder="@tu_usuario" />
                                </div>
                                <div>
                                    ...
                                    <x-text-input id="redes_tiktok" class="block mt-1 w-full bg-black/30 border-red-500/30 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500" 
                                                  type="text" name="redes[tiktok]" :value="old('redes.tiktok', $user->redes['tiktok'] ?? '')" placeholder="@tu_usuario" />
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="flex items-center">
                                <input id="es_admin" type="checkbox" name="es_admin" value="1" 
                                       {{ old('es_admin', $user->es_admin) ? 'checked' : '' }}
