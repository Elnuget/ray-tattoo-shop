                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-red-500/20">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Visible</th>
                            ...
                            <tbody class="divide-y divide-red-500/20">
                                @forelse($users as $user)
                                    <tr class="hover:bg-black/30 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($user->visible)
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-600/20 text-green-300 border border-green-500/30">
                                                    <i class="bi bi-eye-fill mr-1"></i>
                                                    Visible
                                                </span>
                                            @else
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-600/20 text-gray-400 border border-gray-500/30">
